...
$page_title = getPageTitle('Bilim Kurulu');
require_once('../includes/header.php');

// Bilim Kurulu içeriğini veritabanından çekme
try {
    $stmt = $db->query("SELECT icerik FROM umyos_bilim_kurulu LIMIT 1");
    $bilim_kurulu = $stmt->fetch();
    if (!$bilim_kurulu || empty($bilim_kurulu['icerik'])) {
        // Varsayılan içerik
        $icerik = 'Bilim Kurulu içeriği henüz eklenmemiş.';
    } else {
        $icerik = $bilim_kurulu['icerik'];
    }
        ...
        <div class="container full-width">
            <div class="content-area">
                <div class="page-content">
                    <h2 class="news-title">
                        <i class="fas fa-user-graduate"></i> Bilim Kurulu
                    </h2>
