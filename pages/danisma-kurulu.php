...
$page_title = getPageTitle('Danışma Kurulu');
require_once('../includes/header.php');

// Danışma Kurulu içeriğini veritabanından çekme
try {
    $stmt = $db->query("SELECT icerik FROM umyos_danisma_kurulu LIMIT 1");
    $danisma_kurulu = $stmt->fetch();
    if (!$danisma_kurulu || empty($danisma_kurulu['icerik'])) {
        // Varsayılan içerik
        $icerik = 'Danışma Kurulu içeriği henüz eklenmemiş.';
    } else {
        $icerik = $danisma_kurulu['icerik'];
    }
        ...
        <div class="container full-width">
            <div class="content-area">
                <div class="page-content">
                    <h2 class="news-title">
                        <i class="fas fa-user-friends"></i> Danışma Kurulu
                    </h2>
