...
$page_title = getPageTitle('Eğitimler');
require_once('../includes/header.php');

// Eğitimler içeriğini veritabanından çekme
try {
    $stmt = $db->query("SELECT icerik FROM umyos_egitimler LIMIT 1");
    $egitimler = $stmt->fetch();
    if (!$egitimler || empty($egitimler['icerik'])) {
        // Varsayılan içerik
        $icerik = 'Eğitimler içeriği henüz eklenmemiş.';
    } else {
        $icerik = $egitimler['icerik'];
    }
        ...
        <div class="container full-width">
            <div class="content-area">
                <div class="page-content">
                    <h2 class="news-title">
                        <i class="fas fa-graduation-cap"></i> Eğitimler
                    </h2>
