...
$page_title = getPageTitle('Düzenleme Kurulu');
require_once('../includes/header.php');

// Düzenleme Kurulu içeriğini veritabanından çekme
try {
    $stmt = $db->query("SELECT icerik FROM umyos_duzenleme_kurulu LIMIT 1");
    $duzenleme_kurulu = $stmt->fetch();
    if (!$duzenleme_kurulu || empty($duzenleme_kurulu['icerik'])) {
        // Varsayılan içerik
        $icerik = 'Düzenleme Kurulu içeriği henüz eklenmemiş.';
    } else {
        $icerik = $duzenleme_kurulu['icerik'];
    }
        ...
        <div class="container full-width">
            <div class="content-area">
                <div class="page-content">
                    <h2 class="news-title">
                        <i class="fas fa-users-cog"></i> Düzenleme Kurulu
                    </h2>
